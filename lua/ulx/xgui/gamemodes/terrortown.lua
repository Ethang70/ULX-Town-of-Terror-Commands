...
--Town of Terror Settings
local gptotsclp = vgui.Create( "DCollapsibleCategory", gppnl ) 
gptotsclp:SetSize( 390, 100)
gptotsclp:SetExpanded( 0 )
gptotsclp:SetLabel( "Town of Terror Settings" )

local gptotslst = vgui.Create( "DPanelList", gptotsclp )
gptotslst:SetPos( 5, 25 )
gptotslst:SetSize( 390, 200 )
gptotslst:SetSpacing( 5 )

local gpsurpct = xlib.makeslider{ label="ttt_survivalist_pct (def. 0.13)", min=0, max=1, decimal=2, repconvar="rep_ttt_survivalist_pct", parent= gptotslst }
gptotslst:AddItem( gpsurpct )

local gpsurmax = xlib.makeslider{ label="ttt_survivalist_max (def. 32)", min=1, max=80, repconvar="rep_ttt_survivalist_max", parent= gptotslst }
gptotslst:AddItem( gpsurmax )

local gpsurmin = xlib.makeslider{ label="ttt_survivalist_realmin_players (def. 2)", min=2, max=30, repconvar="rep_ttt_survivalist_realmin_players", parent= gptotslst }
gptotslst:AddItem ( gpsurmin )

local gpjespct = xlib.makeslider{ label="ttt_jester_pct (def 0.13)", min=0, max=1, decimal=2, repconvar="rep_ttt_jester_pct", parent= gptotslst }
gptotslst:AddItem ( gpjespct )

local gpjesmin = xlib.makeslider{ label="ttt_jester_realmin_players (def 6)", min =3, max=30, repconvar="rep_ttt_jester_realmin_players", parent= gptotslst }
gptotslst:AddItem ( gpjesmin )

local gpphopct = xlib.makeslider{ label="ttt_phoenix_pct (def 0.13)", min=0, max=1, decimal=2, repconvar="rep_ttt_phoenix_pct", parent= gptotslst }
gptotslst:AddItem ( gpphopct )

local gpphomin = xlib.makeslider{ label="ttt_phoenix_realmin_players (def 5)", min=2, max=30, repconvar="rep_ttt_phoenix_realmin_players", parent= gptotslst }
gptotslst:AddItem ( gpphomin )

local gpranrole = xlib.makeslider{ label="ttt_randomnewroles (def 0) If 1 roles will be disabled randomly", min=0, max=1, repconvar="rep_ttt_randomnewroles", parent= gptotslst }
gptotslst:AddItem ( gpranrole )
--------------------Karma Module--------------------
