...
local function init()
	if GetConVarString("gamemode") == "terrortown" then --Only execute the following code if it's a terrortown gamemode
		...
		ULib.replicatedWritableCvar( "ttt_survivalist_pct", "rep_ttt_survivalist_pct", GetConVarNumber( "ttt_survivalist_pct" ), false, false, "xgui_gmsettings" )
		ULib.replicatedWritableCvar( "ttt_survivalist_max", "rep_ttt_survivalist_max", GetConVarNumber( "ttt_survivalist_max" ), false, false, "xgui_gmsettings" )
		ULib.replicatedWritableCvar( "ttt_survivalist_realmin_players", "rep_ttt_survivalist_realmin_players", GetConVarNumber( "ttt_survivalist_realmin_players"), false, false, "xgui_gmsettings" )
		ULib.replicatedWritableCvar( "ttt_jester_pct", "rep_ttt_jester_pct", GetConVarNumber( "ttt_jester_pct" ), false, false, "xgui_gmsettings" )
        ULib.replicatedWritableCvar( "ttt_jester_realmin_players", "rep_ttt_jester_realmin_players", GetConVarNumber( "ttt_jester_realmin_players" ), false, false, "xgui_gmsettings" )
		ULib.replicatedWritableCvar( "ttt_phoenix_pct", "rep_ttt_phoenix_pct", GetConVarNumber( "ttt_phoenix_pct" ), false, false, "xgui_gmsettings" )
		ULib.replicatedWritableCvar( "ttt_phoenix_pct", "rep_ttt_phoenix_pct", GetConVarNumber( "ttt_phoenix_pct" ), false, false, "xgui_gmsettings" )
		ULib.replicatedWritableCvar( "ttt_randomnewroles", "rep_ttt_randomnewroles", GetConVarNumber( "ttt_randomnewroles" ), false, false, "xgui_gmsettings" )
